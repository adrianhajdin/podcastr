...
Replace the placeholder values with your actual Convex, Clerk and OpenAI credentials. You can obtain these credentials by signing up on the [Convex](https://www.convex.dev/) and [Clerk](https://clerk.com/) websites.
